...
<div
	...
	<label for="title"> <g:message code="recipe.title.label"
...
<div
	class="fieldcontain ${hasErrors(bean: recipeInstance, field: 'body', 'error')} required">
	<label for="body"> <g:message code="recipe.body.label"
			default="Body" /> <span class="required-indicator">*</span>
	</label>
...
<div
	class="fieldcontain ${hasErrors(bean: recipeInstance, field: 'category', 'error')} required">
	<label for="category"> <g:message code="recipe.category.label"
			default="Category" /> <span class="required-indicator">*</span>
	</label>
	<g:select id="category" name="category.id"
		from="${categoryInstanceList}" optionKey="id" optionValue="name"
		required="" value="${recipeInstance?.category?.id}"
		class="many-to-one"
...
<div
	class="fieldcontain ${hasErrors(bean: recipeInstance, field: 'subCategory', 'error')} ">
	<label for="subCategory"> <g:message
			code="recipe.subCategory.label" default="Sub Category" />
	</label>
	<g:select id="subCategory" name="subCategory.id"
		from="${subCategories}" optionKey="id" optionValue="name"
		required="false" />
</div>
