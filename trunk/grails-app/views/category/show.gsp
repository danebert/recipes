	...
	<body>
		...
		<div id="show-category" class="content scaffold-show" role="main">
			...
			<ol class="property-list category">
				...
				<li class="fieldcontain">
					<span id="rank-label" class="property-label"><g:message code="category.rank.label" default="Rank" /></span>
					
						<span class="property-value" aria-labelledby="rank-label"><g:fieldValue bean="${categoryInstance}" field="rank"/></span>
