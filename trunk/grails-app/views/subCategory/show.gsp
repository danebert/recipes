	...
	<body>
		...
		<div id="show-subCategory" class="content scaffold-show" role="main">
			...
			<ol class="property-list subCategory">
				...
				<li class="fieldcontain">
					<span id="rank-label" class="property-label"><g:message code="subCategory.rank.label" default="Rank" /></span>
					
						<span class="property-value" aria-labelledby="rank-label"><g:fieldValue bean="${subCategoryInstance}" field="rank"/></span>
