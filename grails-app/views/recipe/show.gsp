	...
	<body>
		...
		<div id="show-recipe" class="content scaffold-show" role="main">
			...
			<ol class="property-list recipe">
				...
				<li class="fieldcontain">
					<span id="body-label" class="property-label"><g:message code="recipe.body.label" default="Body" /></span>
					
						<span class="property-value" aria-labelledby="body-label"><g:fieldValue bean="${recipeInstance}" field="body"/></span>
